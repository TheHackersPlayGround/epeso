...
export const emptyForm: Omit<GIPApplicant, 'id'> = {
  ...
  assignmentHistory: [],
  lastCompletedWorkplaceTitle: null,
...
function AttachedDocsEditor({ docs, onChange, onPreview }: { docs: GIPSavedDocument[]; onChange: (docs: GIPSavedDocument[]) => void; onPreview: (doc: GIPSavedDocument) => void }) {
