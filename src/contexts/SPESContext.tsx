...
const mockApplicants: SPESApplicant[] = [
  {
    ...
    assignmentHistory: [{ batchId: 1, batchName: 'Special Program for Employment of Students 2026', assignedDate: '2026-04-01' }],
    attachedDocuments: [],
  ...
  },
  {
    ...
    assignmentHistory: [{ batchId: 1, batchName: 'Special Program for Employment of Students 2026', assignedDate: '2026-04-05' }],
    attachedDocuments: [],
