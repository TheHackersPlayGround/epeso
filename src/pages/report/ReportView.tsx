      ...
      case 'skills-training': {
        ...
        return skillsProfiles
          ...
          .map((p, i) => ({
            ...
            'Classification': p.classification?.length ? p.classification.join(', ') : '-',
            'Desired Qualification': p.desiredQualification?.length ? p.desiredQualification.join(', ') : '-',
            'Purpose of Training': p.purposeOfTraining?.length ? p.purposeOfTraining.join(', ') : '-',
